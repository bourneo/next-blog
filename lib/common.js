...
import remarkToc from 'rehype-toc';
// PlantUML
  ...
  return {
    ...
    content: await serialize(content, {
      mdxOptions: {
        ...
        // remark-github, @agentofuser/remark-oembed
        remarkPlugins: [simplePlantUML, externalLinks, prism, gfm],
        // image optimisation to html
        // rehype-toc, rehype-slug, rehype-autolink-headings
        rehypePlugins: [
          imageSlug,
          autolink,
          [
